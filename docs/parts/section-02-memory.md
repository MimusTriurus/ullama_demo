...
Так модель отвечает, опираясь на реальное состояние игры, а не на выдумку. Осталось разобраться, что мы называем "базой знаний", потому что устроена она не совсем так, как принято в класическом RAG.
...
Главное свойство: **поиск идёт по смыслу, а не по словам.** Десяток формулировок одной просьбы ("беру помповое", "дай двустволку") ведут к одному намерению ("SellItem | item: shotgun").
