...
Значит, к промпту нужен второй "ограничитель", который уже не просит, а **запрещает** (вместе они образуют этакий **harness** — страховочную обвязку вокруг LLM). Эту роль играет **валидация output токенов** — грамматики [**GBNF**](https://github.com/ggml-org/llama.cpp/blob/master/grammars/README.md) из [`llama.cpp`](https://github.com/ggml-org/llama.cpp).
