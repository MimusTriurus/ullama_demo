...
1. [Три проблемы прототипа и три решения](#1-три-проблемы-прототипа-и-три-решения)
...
> **Видео:** NPC последовательно произносит пять реплик - по одной на `Neutral`, `Happy`, `Sad`, `Angry` и `Surprise`. Фраза для озвучки и тэг эмоции фиксированы, LLM в этом процессе не участвует.
